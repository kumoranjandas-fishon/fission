              ...
              <>
                ...
                {orders.length===0 ? (
                  <div style={{textAlign:'center',padding:'60px 0',color:'rgba(255,255,255,0.2)'}}>
                    ...
                    <a href="/" style={{display:'inline-block',background:'#DC2626',color:'white',textDecoration:'none',padding:'12px 24px',borderRadius:12,fontWeight:700}}>Order Now →</a>
                  </div>
                ) : orders.map(order=>(
      ...
      {selectedOrder && (
        <div onClick={()=>setSelectedOrder(null)} style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.85)',zIndex:500,display:'flex',alignItems:'flex-end',justifyContent:'center'}}>
          <div onClick={e=>e.stopPropagation()} style={{background:'#0f172a',width:'100%',maxWidth:600,borderRadius:'20px 20px 0 0',padding:24,maxHeight:'85vh',overflowY:'auto',border:'1px solid rgba(255,255,255,0.1)'}}>
            ...
            {/* Reorder Button */}
            <a href="/" style={{display:'block',width:'100%',background:'#DC2626',color:'white',textDecoration:'none',padding:14,borderRadius:12,fontWeight:700,fontSize:15,textAlign:'center',boxSizing:'border-box'}}>
              🛒 Order Again
            </a>
          </div>
        </div>
